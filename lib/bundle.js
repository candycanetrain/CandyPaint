...
var PaintView = function () {
  function PaintView(canvasEl, ctx, imgs) {
    ...
    value: function init() {
      ...
      this.imgs.forEach(function (img) {
        img.addEventListener('click', function (e) {
          if (_this.brush != undefined) {
            document.getElementById(_this.brush.id).className = "";
          }
          _this.setBrush(img.id, e);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var all_icons = document.getElementById("brush-toolbox").getElementsByTagName("img");
  var all_icons_array = _lodash2.default.toArray(all_icons);
  // let stage = new createjs.Stage("canvas"); //ctx
  new _paintview2.default(canvasEl, ctx, all_icons_array).init();
